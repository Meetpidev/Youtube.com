...
function Searchbar() {
  ...
  const searchTitles = useSelector(state =>state.videoReducer)?.data?.filter((q) => q?.videoTitle.toUpperCase().includes(searchQuary.toUpperCase())).map((m)=>m?.videoTitle);
    ...
    <div className="searchbar_container">
       <div className="searchbar_container2">
          <div className="search_div">
            ...
            {
              searchQuary && searchList && <SearchList TitleArray={searchTitles}></SearchList>
